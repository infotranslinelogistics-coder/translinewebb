  ...
  return <>
    <section className="heroSection" id="top">
      <div className="heroSection__copy">
        ...
        <div className="heroSection__actions heroEnter"><a className="button button--primary" href="/quote">Book now <ArrowRight /></a><a className="button button--line" href="/freight">Explore freight <ArrowDown /></a></div>
      ...
      <div className="dispatchTicker"><span className="dispatchTicker__pulse" /><strong>Direct to dispatch</strong><span>Freight · Hotshots · Express · Removals</span><a className="data-value" href="tel:+61466582734">0466 582 734 ↗</a></div>
    </section>
    ...
    <section className="closingCta"><span className="eyebrow">Have something to move?</span><a href="/quote">Book<br />now.<MoveUpRight /></a><p>Send dispatch the load and destination. Your booking is confirmed after the job is accepted.</p></section>
  </>;
}
