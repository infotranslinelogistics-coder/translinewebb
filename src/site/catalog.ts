...
export const services = [
  ...
  { slug: 'courier', name: 'Courier', tag: 'Parcels + time-sensitive jobs', body: 'Documents, parcels and smaller consignments across Perth. Give dispatch both addresses and the required delivery window so availability can be checked.', details: ['Parcel sizes and quantities', 'Pickup and delivery windows', 'Receiver name and contact number'], fit: 'Cargo van for smaller consignments and accessible metro collections.' },
...
const core: PageInfo[] = [
  { path: '/', kind: 'home', title: 'Transline Logistics | Perth Freight, Courier & Removals', heading: 'Built to move.', description: 'Freight, courier and removals from Perth across Western Australia. Speak directly with Transline dispatch to match your load, vehicle and delivery window.', index: true },
  { path: '/freight', kind: 'freight', title: 'Freight & Transport Services in Perth | Transline Logistics', heading: 'The right move. For every load.', description: 'Explore general freight, courier, oversize transport and removals with Transline Logistics. Get the load and access details ready for a direct dispatch quote.', index: true },
  ...
  { path: '/quote', kind: 'quote', title: 'Request a Freight Quote | Transline Logistics Perth', heading: 'Load. Location. Let’s move.', description: 'Prepare a freight, courier or removals quote with your pickup, destination, load size and preferred window. Send the details directly to Transline dispatch.', index: true },
